...
#ifndef _RG_TARGET_CONFIG_H_/* * RetroGo Configuration - Kynex Sovereign Digital Maestro (v250.0)
 * Geliştirici: Muhammed (Kynex)
 * Özellikler: MAX98357A I2S Digital Audio, Stable UI, HW BOOT Anchor
 * Donanım: ESP32-S3 N16R8
 * Talimat: Asla satır silmeden, tam ve tek parça kod.
 */
...
// Target definition
#define RG_TARGET_NAME             "KYNEX-SOVEREIGN-DUALBOOT-V250"
...
// AUDIO (MUHAMMED: I2S DIJITAL SES MODULU AKTIF EDILDI - MAX98357A)
#define RG_AUDIO_USE_INT_DAC        0   
#define RG_AUDIO_USE_EXT_DAC        1   // PWM yerine Harici I2S (Dijital) kullan!
#define RG_AUDIO_USE_PWM            0   // PWM kirliliğini tamamen kapattık!
#define RG_GPIO_SND_I2S_BCK         GPIO_NUM_18 // Modüldeki BCLK Pini
#define RG_GPIO_SND_I2S_WS          GPIO_NUM_8  // Modüldeki LRC Pini
#define RG_GPIO_SND_I2S_DATA        GPIO_NUM_3  // Modüldeki DIN Pini
