// Target definition
#define RG_TARGET_NAME             "KYNEX-S3-CONSOLE"

// Storage (SD Kart Yok - Dahili FFat Kullanımı)
#define RG_STORAGE_ROOT             "/ffat"
#define RG_STORAGE_FLASH_PARTITION  "ffat"
// #define RG_STORAGE_SDSPI_HOST       SPI3_HOST
// #define RG_STORAGE_SDSPI_SPEED      SDMMC_FREQ_DEFAULT

// Audio (1-Pin PWM Hoparlör Modu)
#define RG_AUDIO_USE_INT_DAC        0   // S3'te dahili DAC yok
#define RG_AUDIO_USE_EXT_DAC        0   // Harici I2S DAC devre dışı
#define RG_AUDIO_USE_PWM            1   // PWM Audio Aktif (Pin 45)
#define RG_GPIO_SND_PWM             GPIO_NUM_45

// Video (Klynex SPI Ekran Dizilimi)
...
// Input (Joystickler 90 Derece Sağ Montaj Fixli)
// Refer to rg_input.h to see all available RG_KEY_* and RG_GAMEPAD_*_MAP types

/* * ✅ JOYSTICK ROTASYON MANTIĞI:
 * Sağa 90 derece monte edildiği için:
 * Fiziksel YUKARI/AŞAĞI artık Pin 4 (ADC_CH3) üzerinden okunur.
 * Fiziksel SOL/SAĞ artık Pin 6 (ADC_CH5) üzerinden okunur.
 */
#define RG_GAMEPAD_ADC_MAP {\
    ...
    {RG_KEY_LEFT,  ADC_UNIT_1, ADC_CHANNEL_5, ADC_ATTEN_DB_11, 0, 1024},\
    {RG_KEY_RIGHT, ADC_UNIT_1, ADC_CHANNEL_5, ADC_ATTEN_DB_11, 3072, 4096},\
}

#define RG_GAMEPAD_GPIO_MAP {\
    {RG_KEY_SELECT, .num = GPIO_NUM_7,  .pullup = 1, .level = 0}, /* Joy1 SW */\
    {RG_KEY_START,  .num = GPIO_NUM_16, .pullup = 1, .level = 0}, /* Joy2 SW */\
    {RG_KEY_MENU,   .num = GPIO_NUM_17, .pullup = 1, .level = 0}, /* Extra Button */\
    {RG_KEY_A,      .num = GPIO_NUM_15, .pullup = 1, .level = 0},\
    {RG_KEY_B,      .num = GPIO_NUM_5,  .pullup = 1, .level = 0},\
}

// Battery (Devreye Göre Opsiyonel)
